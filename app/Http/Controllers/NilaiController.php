...
class NilaiController extends Controller
{
    ...
    public function progress()
    {
        ...
        $data = Nilaimapel::query()
            ...
            ->selectRaw('nilaimapel.id, kelas.kelas,  semester.semester, semester.ket_semester, guru.nama_guru,  kelasmi.periode_id, periode.periode, count(nilai.nilai_harian) as jumlah_nilai_harian, count(nilai.nilai_ujian) as jumlah_nilai_ujian, jumlah_peserta_kelas')
            ->where('kelasmi.periode_id', session('periode_id'))
            ->groupBy(
                'nilaimapel.id',
                'kelas.kelas',
