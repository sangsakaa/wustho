        ...
        <div class=" mx-auto ">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg text-sm sm:text-sm">
                <div class="p-2 bg-white border-b border-gray-200">
                    ...
                    <span class="   font-semibold ">Kelas : 2</span>
                    <table class=" mb-4  w-full">
                        ...
                        <tbody>
                            @foreach ($jadwalByDayMap2 as $hari => $jadwals)
                            ...
                            <tr class=" border text-sm border-green-800 capitalize text-center even:bg-gray-100">
                                @endif
                                <td class=" border text-sm border-green-800 capitalize text-center py-0">{{ $jadwal->id }}</td>
