                ...
                <div class="flex-1 flex items-center justify-center sm:items-stretch sm:justify-start">
                    <div class=" sm:block sm:ml-6">
                        <div class="flex space-x-4">
                            ...
                            <a href="#" class="text-gray-300 hover:bg-gray-700 hover:text-white px-3 py-2 rounded-md sm:text-xs text-xs font-medium">DATA PERINGKAT</a>
                            <a href="#" class="text-gray-300 hover:bg-gray-700 hover:text-white px-3 py-2 rounded-md sm:text-xs text-xs font-medium">DATA ANGKATAN</a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class=" max-w-6xl mx-auto sm:px-2 lg:px-2 mt-2">
            <div class=" text-center ">
                <center>
                    ...
                    <span class=" dark:text-white  text-lg uppercase ">Sistem Manajemen Diniyah</span>
                </center>
            </div>
        </div>
    </div>
