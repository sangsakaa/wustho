                                            ...
                                            @foreach ($kelasMI as $item)
                                                <tr class=" hover:bg-green-200 border">
                                                    ...
                                                    <td class=" text-xs text-center border"> {{ $item->periode }}
                                                        {{ $item->ket_semester }}</td>
                                                    <td class=" text-xs text-center border"><a
                                                            href="/presensikelas/{{ $item->id }}">
                                                            {{ $item->kelas }}</a></td>
                                                    <td class=" text-xs text-center py-2"><a
                                                            href="/presensikelas/{{ $item->id }}"
                                                            class=" text-xs bg-blue-600 text-white py-1 px-2 rounded-md hover:bg-purple-600">Kelas
                                                            {{ $item->nama_kelas }}</a></td>
                                                    <td class=" text-xs text-center border"> {{ $item->kuota }}</td>
                                                    <td class=" text-xs text-center border">
                                                        {{ $item->jumlah_nilai_ujian }}</td>
