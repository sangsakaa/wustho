            ...
            <div class="  grid grid-cols-2 w-full gap-1">
                <div class=" text-sm flex gap-2 ">
                    ...
                    <div class="  grid justify-end">
                        <input type="search" wire:model="search" class=" py-0.5 " placeholder=" cari nama asrama">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="p-2 bg-blue-200 border-b border-gray-200">
                <div class="flex justify-items-end grid-cols-1 gap-2  py-1">
                    <div class=" text-sm grid grid-cols-1">
                        ...
                        <div class=" px-2">
                            <p class=" capitalize">1. Untuk penambahan <b>anggota asrama </b> <u>wajib</u> memiliki <b><u>NIM (nomor induk murid)</u></b> </p>
                            <p class=" capitalize">2. jika tidak memiliki harap <b>NIM (nomor induk murid)</b> konfimasi ke pihak madin bagian <b>kesiswaan & kepala sekolah</b> </p>
                        </div>
                    </div>
                </div>
            </div>
