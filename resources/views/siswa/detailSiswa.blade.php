                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                    <div>
                        ...
                        <p class="text-sm font-medium text-gray-800 dark:text-white flex items-center gap-1.5">
                            <svg class="w-4 h-4 {{ $siswa->jenis_kelamin == 'L' ? 'text-blue-500' : 'text-pink-500' }}" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <div class="overflow-x-auto p-1">
                        <table class="w-full text-sm">
                            ...
                            <tbody class="divide-y divide-slate-100 dark:divide-gray-800">
                                ...
                                @empty
                                <tr>
                                    <td colspan="3" class="text-center py-6 text-slate-400">Data tidak tersedia</td>
                                </tr>
                                @endforelse
                            </tbody>
                        </table>
