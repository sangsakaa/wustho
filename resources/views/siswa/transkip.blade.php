                ...
                <div class="p-2 bg-white border-b border-gray-200">
                    <div class="px-1 py-2 bg-white border-b border-gray-200 grid grid-cols-2 sm:grid-cols-2 gap-2">
                        ...
                        <div class=" flex gap-1">
                            ...
                            <a href="/transkip/{{$siswa->id}}" target="_blank" class=" flex text-white rounded-md  bg-green-800 px-2 py-1 "><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
