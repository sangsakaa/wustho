<thead class="bg-gradient-to-r from-slate-50 to-slate-100 text-slate-600 text-xs uppercase tracking-wider">
  <tr>
    ...
    <th class="px-4 py-3.5 text-center">Agama</th>
    <th class="px-4 py-3.5 text-center">TTL</th>
...
<tbody class="divide-y divide-slate-100">
  ...
  <tr class="hover:bg-slate-50 transition-colors duration-150 even:bg-slate-50/50">
    ...
    <td class="px-4 py-3.5 text-center text-slate-600 text-xs">{{ $item->agama }}</td>

    <td class="px-4 py-3.5 text-xs text-center text-slate-600">
      {{ $item->tempat_lahir }},
      {{ $item->tanggal_lahir 
