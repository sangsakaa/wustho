                                        ...
                                        <tr class=" hover:bg-green-200 border">
                                            ...
                                            <td class=" text-xs  text-center mt-2  flex gap-1 justify-center  align-middle   ">
                                                <form action="/kelas_mi/{{$item->id}}" method="post">
                                                    @csrf
                                                    @method('delete')
                                                    <button class=" text-xs bg-red-500 text-white p-1 rounded-md" onclick=" return confirm('apakah anda yakin menhapus data ini:{{$item->nama_kelas}}') "><svg xmlns="http://www.w3.org/2000/svg" class=" text-xsh-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
