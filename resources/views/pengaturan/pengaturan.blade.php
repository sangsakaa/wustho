                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class=" bg-white border-b border-gray-200">
                        <div class=" p-6 flex grid-cols-1 gap-1">
                            ...
                            <a href="/raportkelas"
                                class=" py-1 px-2 bg-blue-600 rounded-md text-white hover:bg-purple-500">
                                raport kelas
                            </a>
                            <a href="/addpelanggaran"
                                class=" py-1 px-2 bg-blue-600 rounded-md text-white hover:bg-purple-500">
                                Add pelanggaran
                            </a>
                        ...
                        <div class=" p-6 grid grid-cols-1">
                            ...
                            <form action="/pengaturan" method="get" class=" flex gap-1">
                                <input type="text" name="cari" value="{{ request('cari') }}"
                                    class=" border border-green-800 text-green-800 rounded-md py-1 "
                                ...
                                <tbody>
                                    @foreach ($raport as $list)
                                        <tr class=" hover:bg-gray-100">
                                            ...
                                            <th class=" border px-2 text-left uppercase">
                                                {{ $list->nama_siswa }}
                                            </th>
                                            ...
                                            <th class=" border px-1 text-center py-1 ">
                                                <a href="/report/{{ $list->id }}"
                                                    class=" justify-center bg-sky-300 rounded-md p-1 text-black flex text-center hover:bg-purple-600 hover:text-white">
