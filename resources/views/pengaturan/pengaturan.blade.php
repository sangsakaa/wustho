                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class=" bg-white border-b border-gray-200">
                        <div class=" p-6 grid grid-cols-1">
                            <span class=" text-center ">LIST CETAK RAPORT</span>
                            <hr class=" py-2">
                            ...
                            <table class=" border mt-2">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <th class=" border px-2 text-center ">
                                            <a href="/report/{{$list->id}}" class=" justify-center bg-green-500 rounded-md p-1 text-white flex text-center"> <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
