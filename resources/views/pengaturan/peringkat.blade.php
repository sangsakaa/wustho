                ...
                <table class=" w-full">
                    <thead class=" bg-green-800  border font-semibold ">
                        <tr class=" text-white">
                            ...
                            <th class=" border border-green-800 px-2" rowspan="2">NIS</th>
                            <th class=" border border-green-800 px-2" rowspan="2">NAMA</th>
                            <th colspan="2" class=" border border-green-800 text-center">TOTAL NILAI</th>
                            <th class=" border border-green-800 px-2" rowspan="2">PERINGKAT</th>
                        </tr>
                        <tr class=" text-white">
                            <th class=" PX-2 text-center">YAUMIYAH</th>
                            <th class=" PX-2 text-center">IMTIHANIYYAH</th>
                        </tr>
                    </thead>
                    @foreach ($ringkasanraportkelas as $pesertakelas_id => $ringkasan)
                        ...
                        <tbody class=" text-md">
                            <tr>
                                ...
                                <td class=" px-2 border border-green-800">{{ $datasiswa->nis }}</td>
                                <td class=" px-2 border border-green-800"> {{ $datasiswa->nama_siswa }}</td>
                                <td class=" px-2 border border-green-800 text-center">{{ $ringkasan['jmlharian'] }}
                                </td>
                                <td class=" px-2 border border-green-800 text-center">{{ $ringkasan['jmlujian'] }}</td>
                                <td class=" px-2 border border-green-800 text-center">{{ $ringkasan['peringkat'] }}
                                </td>
                            </tr>
                        </tbody>
                    @endforeach
