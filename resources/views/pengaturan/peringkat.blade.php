            ...
            <table class=" w-full">
                ...
                <tbody class=" text-md">
                    <tr>
                        ...
                        <td class=" px-2 text-sm border border-green-800 text-center">{{ $ringkasan['jmlujian'] }}</td>
                        <td class=" px-2 text-sm border border-green-800 text-center">{{ $ringkasan['peringkat'] }}
                        </td>
                    </tr>
                </tbody>
                @endforeach
