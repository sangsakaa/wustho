        ...
        <div class=" mx-auto ">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-md">
                <div class="p-2 border-b border-gray-200">
                    <div class=" flex w-full  grid-cols-1 sm:grid-cols-3 gap-1">
                        @can('show post')
                        <a href="/addasrama">
                        ...
                        @endcan
                        <a href="/sesiasrama">
                            <button class=" flex  w-full bg-blue-500 text-white p-1 rounded-md"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
